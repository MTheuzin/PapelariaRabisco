...
def cadastro_produto():
    try:
        ...
        comandoSQL = 'INSERT INTO Produto (nome, descicao, preco, quantidade)VALUES (%s, %s, %s, %s)'
...
def update_produto():
    try:
        ...
        if not all (not idproduto) or (not nome) or (not descricao) or (not preco) or (not quantidade):
